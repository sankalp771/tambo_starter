        ...
        return (
          ...
          >
            <Message
              ...
              className="flex w-full max-w-[85%]"
            >
              <div
                className={cn(
                  "flex flex-col gap-1",
                  isAssistant ? "items-start w-full" : "items-end ml-auto"
                )}
              >
                {/* Reasoning UI */}
                <ReasoningInfo className="mb-1" />
                ...
                <div className={cn(
                  ...
                  isAssistant
                    ? "bg-blue-50/50 rounded-2xl rounded-tl-none border border-blue-100/50"
                    : "bg-blue-600 rounded-2xl rounded-tr-none text-white shadow-blue-200"
                )}>
                  <MessageContent className="p-3" />
                </div>

                {/* Tool Call UI */}
                <ToolcallInfo className="mt-1" />

                {/* Interactable UI (only for assistant) */}
                {isAssistant && <MessageRenderedComponentArea className="w-full mt-2" />}
              </div>
            </Message>
          </div>
        );
